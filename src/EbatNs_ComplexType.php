...
// $Id: EbatNs_ComplexType.php,v 1.7 2013-04-08 10:30:09 thomasbiniasch Exp $

// $Log: EbatNs_ComplexType.php,v $
// Revision 1.7  2013-04-08 10:30:09  thomasbiniasch
...
{ 
...

	{
		...
		self::$_elements[join('', array_slice(explode('\\', __CLASS__), -1))] = array();
...

    {
        ...
        //unset($this->_elements[join('', array_slice(explode('\\', $class), -1))]);
...

    {
       ...
       if ($class === null)
        ...
        return self::$_elements[join('', array_slice(explode('\\', $class), -1))];
...

    {
        ...
        self::$_elements[join('', array_slice(explode('\\', $class), -1))][$elementName] = $metaData;
