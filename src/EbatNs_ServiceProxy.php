...
class EbatNs_ServiceProxy extends EbatNs_Client
{
	...
	{
		$request->setVersion(EBAY_WSDL_VERSION);
        //ToDo: Dieser Aufruf funktioniert nicht mehr in der aktuellen Version, stattdessen wird der Standardaufruf Call verwendet
		//return $this->callXmlStyle('UploadSiteHostedPictures', $request);
        return $this->call('UploadSiteHostedPictures', $request);
	}
	/**
